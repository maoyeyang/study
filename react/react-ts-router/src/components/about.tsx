    ...
    <div className="row about-page col-12">
      ...
      <div className="col-10" id="header-title">
        ...
        <div className="col-10">
          <h3>
            <small>We are adding page navigation to this project:</small>
          </h3>
          ...
          <ul>
            ...
            <li>
              <h3>
                <small>
                  The user can navigate by clicking on links in a common navbar.
                </small>
              </h3>
            </li>
          </ul>
          ...
          <h3>
            <small>
              We are using{' '}
              <a target="_blank" href="https://github.com/reactjs/react-router">
                react-router
              </a>{' '}
              for the navigation support
            </small>
          </h3>
        </div>
      </div>
